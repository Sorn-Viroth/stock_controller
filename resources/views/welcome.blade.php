...
<body  class="p-3 mb-5 bg-body rounded;">
    <thead>
        <h1><center>WELCOME</center></h1>
        <center>
            <div class="form-group text-center; mb-3">
                <a class="btn btn-primary" style="width:20rem" type="button" value="Data" href="register-list">Data</a>
                <a class="btn btn-primary" style="width:20rem" type="button" value="Register" href="/register">Register</a>
