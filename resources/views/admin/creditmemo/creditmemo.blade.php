            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a  @click="loading()"
                            href="/admin/creditmemo" class="btn btn-primary btn-sm" style="padding: 5.5px 15px;
                            border: 0;
                            border-radius: 100px;
                            color: #ffffff;
                            font-weight: Bold;
                        ...
                        <a  @click="loading()"
                            href="/admin/creditmemo" class="btn btn-danger btn-sm" style="padding: 5.5px 15px;
                            border: 0;
                            border-radius: 100px;
                            color: #ffffff;
                            font-weight: Bold;
                        ...
                        <a @click="loading()"
                            href="/admin/creditmemo" class="btn btn-success btn-sm" style="padding: 5.5px 15px;
                            border: 0;
                            border-radius: 100px;
                            color: #ffffff;
                            font-weight: Bold;
                        ...
                        <a  @click="showModalInvoice()"
                            href="#" class="btn btn-light btn-sm" style="float: right">
                            <i class="fas fa-search"></i>
                        </a>
                        <input style="float: right" class="" type="text" name="search" placeholder="Select to Invoice">
                    </div>
                    <div class="card-body">
                        <form class="row g-3">
                            <div class="col-md-6 ">
                            ...
                            <a type="text" class="form-control" id="inputEmail4" placeholder="...">CR-0000001</a>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div>
                                ...
                                <table class="table table-head-fixed text-nowrap table-striped">
                                    ...
                                    <tr v-for="(item, index) in 50">
                                        ...
                                        <td>
                                            <a  @click="loading()"
                                                href="/admin/creditmemo" class="btn btn-sm btn-info" style="padding: 5.5px 15px;
                                                                                    border: 0;
                                                                                    border-radius: 100px;
                                                                                    color: #ffffff;
                                                                                    font-weight: Bold;
                            ...
                            <div>
                                ...
                                <table class="table table-head-fixed text-nowrap table-striped">
                                    ...
                                    <tr v-for="(item, index) in 50">
                                        ...
                                        <td>
                                            <a  @click="loading()"
                                                href="/admin/creditmemo" class="btn btn-sm" style="padding: 5.5px 15px;
                                                border: 0;
                                                border-radius: 100px;
                                    ...
                                    <table class="table table-head-fixed text-nowrap table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            >
                                                ...
                                                <td>
                                                    <a @click="loading()"
                                                        href="/admin/creditmemo" class="btn btn-info btn-sm" style="padding: 5.5px 15px;
                                                                                                border: 0;
                                                                                                border-radius: 100px;
                                                                                                background-color: rgb(54, 174, 30);
                                                                                                color: #ffffff;
