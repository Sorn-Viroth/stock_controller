...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="mb-2 row">
        <div class="col-sm-6">
          <h1 class="m-0">Issus Report</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Issus Report</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div id="app" class="content">
        ...
        <div class="row">
            <div class="col-12">
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in 10">
                                        ...
                                        <td>
                                            <a
                                                @click="loading()"
                                                href="/admin/rp-issueitem" class="btn btn-danger btn-sm" style="padding: 5.5px 15px;
                                                                                        border: 0;
                                                                                        border-radius: 100px;
                        ...
                        <div>
                            ...
                            <table class="table table-head-fixed text-nowrap table-striped">
                                ...
                                <tr v-for="(item, index) in 50">
                                    ...
                                    <td>
                                        <a  @click="loading()"
                                            href="/admin/resive-item" class="btn btn-sm btn-info" style="padding: 5.5px 15px;
                                                                                border: 0;
                                                                                border-radius: 100px;
                                                                                background-color: rgb(26, 160, 19);
                                                                                color: #ffffff;
                ...
                <!-- Modal-Receive -->
                <div class="modal fade" id="receive" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Receive List</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        </div>
