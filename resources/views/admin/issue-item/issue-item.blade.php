...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="mb-2 row">
        <div class="col-sm-6">
          <h1 class="m-0">Issus Item</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Issus Item</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3">
                            ...
                            <a type="text" class="form-control" id="inputEmail4" placeholder="...">IS0000001</a>
                            </div>
                            <div class="col-md-6">
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in 10">
                                        ...
                                        <td>
                                            <a
                                                @click="loading()"
                                                href="/admin/issue-item" class="btn btn-danger btn-sm" style="padding: 5.5px 15px;
                                                                                        border: 0;
                                                                                        border-radius: 100px;
                        ...
                        <div>
                            ...
                            <table class="table table-head-fixed text-nowrap table-striped">
                                ...
                                <tr v-for="(item, index) in 50">
                                    ...
                                    <td>
                                        <a  @click="loading()"
                                            href="/admin/issue-item" class="btn btn-sm btn-info" style="padding: 5.5px 15px;
                                                                                border: 0;
                                                                                border-radius: 100px;
                                                                                background-color: rgb(26, 160, 19);
                                                                                color: #ffffff;
