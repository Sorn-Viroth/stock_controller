...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="mb-2 row">
        <div class="col-sm-6">
          <h1 class="m-0">Customer Balance</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                                                ...
                                                <table class="table table-head-fixed text-nowrap table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in 50">
                                                            ...
                                                            <td>
                                                                <a href="/admin/receivepayment" class="btn btn-sm" style="padding: 5.5px 15px;
                                                                border: 0;
                                                                border-radius: 100px;
                                                                background-color: rgb(49, 148, 9);
                                                                color: #ffffff;
                                                                font-weight: Bold;
                                                                transition: all 0.5s;
                                                                -webkit-transition: all 0.5s;">
