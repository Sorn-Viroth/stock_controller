                                                            ...
                                                            <tbody>
                                                                <tr v-for="(item, index) in 50">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a  @click="loading()"
                                                                            href="/admin/vendor-list" class="btn btn-danger btn-sm" style="padding: 5.5px 15px;
                                                                            border: 0;
                                                                            border-radius: 100px;
                                                                            color: #ffffff;
                                                                            font-weight: Bold;
                        ...
                        <div>
                            ...
                            <table class="table table-head-fixed text-nowrap table-striped">
                                ...
                                <tr v-for="(item, index) in 50">
                                    ...
                                    <td>
                                        <a  @click="loading()"
                                        href="/admin/vendor-list" class="btn btn-sm" style="padding: 5.5px 15px;
                                        border: 0;
                                        border-radius: 100px;
                                ...
                                <table class="table table-head-fixed text-nowrap table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            <td>
                                                <a @click="loading()"
                                                    href="/admin/vendor-list" class="btn btn-info btn-sm" style="padding: 5.5px 15px;
                                                                                            border: 0;
                                                                                            border-radius: 100px;
                                                                                            background-color: rgb(54, 174, 30);
                                                                                            color: #ffffff;
